...
public class Order {
    ...
    public static TreeSet<Order> toTreeSet(List<Order> orders) {
        ...
        Comparator<Order> compareByFirstIsOpenThenAmountThenTime = Comparator
                .comparing(Order::isOpen).reversed()
                .thenComparing(Comparator.comparing(Order::getAmount).reversed())
                .thenComparing(Order::getOrderTime)
                .thenComparing(Order::getId);

        TreeSet<Order> set = new TreeSet<>(compareByFirstIsOpenThenAmountThenTime);
        set.addAll(orders);
        return set;
    }
